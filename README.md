...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p ad2bcd61-39c2-45ac-a283-ab55f94a8bf0
```

> `ad2bcd61-39c2-45ac-a283-ab55f94a8bf0` is the password of the certificate, you can change it to any password you want.
